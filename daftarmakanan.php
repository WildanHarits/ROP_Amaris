...
while($row = mysqli_fetch_assoc($result)){
	if(isset($_POST['edit-'.$row['id_makanan']])){
		header("Location:editmakanan.php?id_makanan=".$row['id_makanan']);	
		}
	}
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <form method='post'>      
		...
		<td><input type='submit' name='edit-".$row['id_makanan']."' value='Edit'><input type='submit' name='delete-".$row['id_makanan']."' value='Delete'></td>
	</tr>";
                }
                echo "</form>";
                ?>  
