...
if(isset($_POST['laporan'])){
      header("Location:printpemakaian.php?tgl=".$_POST['tgllaporan']);
    }
  if(isset($_POST['laporanbulanan'])){
      header("Location:printpemakaian.php?bln=".$_POST['bulanan']."&thn=".$_POST['tahunan']);
    }
if(isset($_POST['simpan'])){
	$sql = "select * from makanan";
	$result = mysqli_query($conn, $sql);
	while($row = mysqli_fetch_assoc($result)){
		$sql2 = "select * from bahan_makanan where id_makanan='".$row['id_makanan']."'";
		//echo $sql2;
		$result2 = mysqli_query($conn, $sql2);
		while($row2 = mysqli_fetch_assoc($result2)){
			if($_POST['jumlah-'.$row['id_makanan']]==""){
				$_POST['jumlah-'.$row['id_makanan']]=0;
			}
			$query="update stok_bahan set jumlah=jumlah-".$row2['jumlah']*$_POST['jumlah-'.$row['id_makanan']]." where id_bahan='".$row2['id_bahan']."'";	
			$conn->query($query);
			
			$query="insert into transaksi_bahan values('".$_POST['tgl']."','".$row2['id_bahan']."','".$row2['jumlah']*$_POST['jumlah-'.$row['id_makanan']]."')";	
			//echo $query;
			if ($conn->query($query) === TRUE){}
			else{
				$query="update transaksi_bahan set jumlah = jumlah + ".$row2['jumlah']*$_POST['jumlah-'.$row['id_makanan']]." where tgl = '".$_POST['tgl']."' and id_bahan='".$row2['id_bahan']."'";	
				//echo $query;
				$conn->query($query);
			}
			//$conn->query($query);
			}
		$query="insert into transaksi_makanan values('".$_POST['tgl']."','".$row['id_makanan']."','".$_POST['jumlah-'.$row['id_makanan']]."')";
		if ($conn->query($query) === TRUE){}
			else{
				$query="update transaksi_makanan set jumlah = jumlah+".$_POST['jumlah-'.$row['id_makanan']]." where id_makanan='".$row['id_makanan']."' and tgl='".$_POST['tgl']."'";	
				echo $query;
				$conn->query($query);
			}
	}
        ...
        <section class="col-lg-12">
          ...
          <div class="box box-info">
            <div class="box-header">
              ...
              <h3 class="box-title">FORM DATA MENU MAKANAN</h3>
              <!-- tools box -->
...
<table id="example1" class="table table-bordered table-hover">
	...
	while($row = mysqli_fetch_assoc($result)){
		echo "<tr>
		<td><input type='text' name='jumlah-".$row['id_makanan']."'></td>
...
<input type="submit" name="simpan" value="Simpan">
          ...
          <div class="box">
            ...
            <div class="box-body">
              <form method="post">
                Laporan Pemakaian Harian: <input type="date" name="tgllaporan"><input type="submit" name="laporan" value="Cetak laporan"><br>
