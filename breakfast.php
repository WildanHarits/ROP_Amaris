...
<html lang="en">
  ...
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
	  <li><a href="http://localhost/bimo/breakfast.php">Breakfast</a></li>
	  <li><a href="http://localhost/bimo">Event</a></li>
      <li><a href="http://localhost/bimo/biasa.php">Print Excel Breakfast</a></li>
    </ul>
  </div>
</nav>
<div>
...
#table-wrapper table thead th .text {
  ...
  border:1px solid red;
	...
	<input type="submit" name="simpan" id="simpan" value="Simpan Breakfast">
	</form>
