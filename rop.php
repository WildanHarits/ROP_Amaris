...
<div class="wrapper">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="rop.php"><i class="fa fa-circle-o"></i> ROP</a></li>
          </ul>
        </li>
      </ul>
    </section>
  ...
  <div class="content-wrapper">
	...
	$result = mysqli_query($conn, $sql);
	while($row = mysqli_fetch_assoc($result)){
		$sql2 = "select MAX(jumlah) a, AVG(jumlah) b from transaksi_bahan where date_format(tgl,'%c') = '".$_POST['bulan']."' and date_format(tgl,'%Y') = '".$_POST['tahun']."' and id_bahan='".$row['id_bahan']."'";	
		//echo $sql2;
		...
		while($row2 = mysqli_fetch_assoc($result2)){
			...
			echo "</td>";
			echo "<td>";
			$hasil = ($row2['a']-$row2['b'])*1;
			$hasil2=($row2['b']*1)+$hasil;
			echo $hasil2;
			echo "</td>";
			echo "</tr>";
		}
